...
export const eventBus = {
   ...
   * @return {eventActions}
   */
  once(name: string, handler: EventListenerOrEventListenerObject) {
   ...
   * @return {eventActions}
   */
  on(name: string, handler: EventListenerOrEventListenerObject) {
   ...
   * @return {eventActions}
   */
  remove(name: string, handler: EventListenerOrEventListenerObject) {
  ...
  dispatch(name: string, params?: any) {
    if(typeof window !== "undefined")
      window.document.dispatchEvent(new CustomEvent(name, params ? {detail: params, cancelable: true} : undefined),);
    return this;
  },
  /**
   ...
   * @return {eventActions}
   */
  registerEvent(name: string, handler: EventListenerOrEventListenerObject, options?: AddEventListenerOptions) {
    if(typeof window !== "undefined")
