...
export const MainPageAPI = {
  getNav: (): AxiosRequestConfig => ({
    url: "/content_types/nav_manu/entries/blt8dc883599851a038?environment=main&include_fallback=true",
  }),
  getHeroBanner: (): AxiosRequestConfig => ({
    url: "/content_types/main_page_hero_banner/entries/blt3085e48965238c9f?environment=main&include_fallback=true",
  }),
  getModels: (): AxiosRequestConfig => ({
    url: "/content_types/cars_carousel_section/entries/bltc249a3d3d10085fa?environment=main&include_fallback=true&include[]=tabs.slides.slide_data&include[]=tabs.slides.slide_sub_item.sub_item_data",
  }),
  getCTA: (): AxiosRequestConfig => ({
    url: "/content_types/cta_section/entries/blt34acc48518d55a58?environment=main&include_fallback=true",
  }),
  getAllPhotoTextBlocks: (): AxiosRequestConfig => ({
    url: "/content_types/photo_text_block/entries?environment=main&include_fallback=true",
  }),
  getMainPageAdHeroData: (): AxiosRequestConfig => ({
    url: "/content_types/main_page_ad_hero_banner/entries/blt048486333eaee9fb?environment=main&include_fallback=true",
  }),
  getAudiFeatures: (): AxiosRequestConfig => ({
    url: "/content_types/audi_feautures/entries/bltbcefbffe5bdb480a?environment=main&include_fallback=true",
  }),
  getFooterData: (): AxiosRequestConfig => ({
    url: `/content_types/${uids.footer.content_type_uid}/entries/${uids.footer.entry_uid}?environment=main`,
  }),
  getElectricCarsData: (): AxiosRequestConfig => ({
    url: `/content_types/${uids.electic_cars.content_type_uid}/entries/${uids.electic_cars.entry_uid}?environment=main`,
  }),
};
